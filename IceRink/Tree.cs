...
namespace IceRink
{
    ...
    {
        public Tree(int x, int y, Color color, int size, int step)
        ...
        public override void Draw(Graphics g)
        {
            ...
            SolidBrush trunkBrush = new SolidBrush
                (Color.FromArgb(180, 110, 30));
        ...
        new SolidBrush(Color.FromArgb(180, 230, 40))
            ...
            RectangleF trunkRect = new RectangleF(X - trunkWidth / 2,
                Y - trunkHeight, trunkWidth, trunkHeight);
            g.FillRectangle(trunkBrush, trunkRect);
            g.DrawRectangle(trunkPen, trunkRect.X,
                trunkRect.Y,trunkRect.Width, trunkRect.Height);
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                float leafTop = Y - trunkHeight - (i + 1) 
                    * leafSegmentHeight;
